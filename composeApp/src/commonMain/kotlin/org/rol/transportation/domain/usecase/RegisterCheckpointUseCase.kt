...
class RegisterCheckpointUseCase(private val repository: TripServicesRepository) {
    suspend operator fun invoke(tripId: Int, request: RegisterLocationRequest) = repository.registerCheckpoint(tripId, request)
}

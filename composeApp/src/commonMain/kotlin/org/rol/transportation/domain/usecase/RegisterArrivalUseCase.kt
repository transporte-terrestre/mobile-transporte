...
class RegisterArrivalUseCase(private val repository: TripServicesRepository) {
    suspend operator fun invoke(tripId: Int, request: RegisterLocationRequest) = repository.registerArrival(tripId, request)
}
